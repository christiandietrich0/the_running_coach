...
export const SETTINGS_GROUPS: SettingsGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { label: 'A taper week -1 min volume (fraction)', path: ['taperA', 'week1MinPct'], step: 0.05 },
      { label: 'A taper week -1 max volume (fraction)', path: ['taperA', 'week1MaxPct'], step: 0.05 },
      { label: 'A taper race week min volume (fraction)', path: ['taperA', 'raceWeekMinPct'], step: 0.05 },
      { label: 'A taper race week max volume (fraction)', path: ['taperA', 'raceWeekMaxPct'], step: 0.05 },
      { label: 'B taper length (weeks)', path: ['taperB', 'weeks'], step: 1 },
      { label: 'B taper min volume (fraction)', path: ['taperB', 'minPct'], step: 0.05 },
      { label: 'B taper max volume (fraction)', path: ['taperB', 'maxPct'], step: 0.05 },
    ],
  },
  {
    title: 'Life caps',
